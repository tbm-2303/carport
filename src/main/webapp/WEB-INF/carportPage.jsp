...
<t:genericpage>
    ...
    <jsp:body>
        Her kan information om den valgte carport.
        NOTE: vi skal bruge en liste med carporte i session. vi skal bruge carport_id til at hente en carport og vise information on denne
        carport på carportPage.jsp.
